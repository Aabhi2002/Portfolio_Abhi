...
export default function Navigation() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-20">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="relative">
            ...
            <div className={`absolute -left-20 -top-10 opacity-30 overflow-hidden transition-all duration-300 ${isScrolled ? 'h-[100px] w-[200px]' : 'h-[200px] w-[200px]'
              }`}>
            ...
            <a href="#hero" className="flex items-center gap-0.5 relative z-10">
              <span className="text-2xl font-light tracking-[0.5em] text-cyan-500">A</span>
      ...
      {/* Mobile menu drawer */}
      <div
        className={`md:hidden fixed inset-0 top-20 bg-[#0A0A0F]/98 backdrop-blur-lg z-40 transition-all duration-300 ${isMobileMenuOpen
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-8 px-8">
          {navLinks.map((link, index) => (
            <a
              ...
              className={`text-2xl tracking-[0.2em] text-zinc-500 hover:text-white transition-all duration-300 ${isMobileMenuOpen
          ...
          {/* Decorative element */}
          <div className={`mt-12 transition-all duration-500 ${isMobileMenuOpen ? 'opacity-20 scale-100' : 'opacity-0 scale-90'
            }`}>
